...
class GraspExecutor:
    ...
    def read_data(self):
        ...
        for session_dir in session_dirs:
            ...
            object_files = glob.glob(os.path.join(session_dir, "unordered_grasps.pkl"))
    ...
    def rank_with_wide_and_deep_model(self, model_filename):
        ...
        for rank, sort_idx in enumerate(sort_indices):
            print(rank, pos_preds[sort_idx], features[sort_idx])

        self.add_scores_to_grasps(sort_indices)
        self.store_semantic_objects_list()

    def add_scores_to_grasps(self, sort_indices):
        for rank, sort_idx in enumerate(sort_indices):
            grasp = self.semantic_objects.objects[0].grasps[sort_idx]
            grasp.score = rank


    def store_semantic_objects_list(self):
        with open("/home/weiyu/catkin_ws/src/rail_semantic_grasping/data/test_execution/2019/ordered_grasps.pkl", "wb") as fh:
            pickle.dump(self.semantic_objects, fh, protocol=2)
...
if __name__ == "__main__":
    ...
    ge.rank_with_wide_and_deep_model("/home/weiyu/catkin_ws/src/rail_semantic_grasping/models/robo_exp_wd.pkl")
